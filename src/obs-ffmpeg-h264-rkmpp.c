...
void h264_rkmpp_defaults(obs_data_t *settings)
{
	obs_data_set_default_int(settings, "bitrate", 2500);
	obs_data_set_default_string(settings, "profile", "main");
}

obs_properties_t *h264_properties(enum h264_rkmpp_encoder_type type)
{
...
obs_properties_t *h264_rkmpp_properties(void *unused)
{
	UNUSED_PARAMETER(unused);
